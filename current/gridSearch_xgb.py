...
tuning_param_dict = {'num_round': [0.0075, 0.005, 0.0025], 'num_round' : [2500, 3500, 4500, 5500, 6500], 'max_depth' : [3, 4, 5, 6, 7]}
...
cv_fold_num = 2
result_file_name = 'xgb_raw_data_bin_{}_GridSearch_{}_fold_Results.csv'.format(data_index, cv_fold_num)
