...
## section to build the row index for regular/nan data
...
train_num = pd.read_csv(join(data_path, train_num_file),    index_col='Id',  skiprows=skipped_train_row_num)
train_dat = pd.read_csv(join(data_path, train_date_file),   index_col='Id',  skiprows=skipped_train_row_num)
test_num = pd.read_csv(join(data_path, test_num_file),      index_col='Id',  skiprows=skipped_test_row_num)
test_dat = pd.read_csv(join(data_path, test_date_file),     index_col='Id',  skiprows=skipped_test_row_num)
...
combined_train.to_csv('FE_raw_regular_train_num_dat_data.csv') 
combined_test.to_csv('FE_raw_regular_test_num_dat_data.csv') 
