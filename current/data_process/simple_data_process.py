...
remove_single_value_columns(train_dat_Norm)
test_dat_Norm = test_dat_Norm[train_dat_Norm.columns]
...
def clean_by_selected_columns(df, columns):
    selected_columns = []
...
clean_by_selected_columns(combined_test_num, combined_train_num.columns)
remove_single_value_columns(combined_train_dat)
clean_by_selected_columns(combined_test_dat, combined_train_dat.columns)



#combined_train = pd.concat([combined_train_num, combined_train_dat, combined_train_cat], axis=1)
combined_train = pd.concat([combined_train_num, combined_train_dat, train_datIndex_features], axis=1)
#combined_train.to_csv('bosch_FE_raw_train_data_regular.csv')
combined_train.to_csv('bosch_FE_raw_train_num_dat_data.csv')
combined_test = pd.concat([combined_test_num, combined_test_dat, test_datIndex_features], axis=1)
combined_test.to_csv('bosch_FE_raw_test_num_dat_data.csv')
