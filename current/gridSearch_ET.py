...
yaml_file = 'complete_subset_data_6_bins_dict.yml'
data_index= '0'
train = load_processed_bosch_data(data_path, project_path, yaml_file, data_index=data_index)
...
cv_fold_num = 2
result_file_name = 'ExtraTree_{}_{}_fold_GridSearch_Results.csv'.format(const_param_dict['criterion'][0], cv_fold_num)
grid_search_cross_validate_model(train, dep_var_name, ExtraTreeModel, score_MCC, param_dict, cv_fold_num, result_file=result_file_name)
